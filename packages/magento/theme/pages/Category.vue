...
import { useCategory, useProduct, productGetters, categoryGetters } from '@vue-storefront/magento';
...
export default {
  ...
  setup(props, context) {
    ...
    const { categories: categoriesInRootTree, loading: categoryTreeLoading } = useCategory('categoryRootTree');
    ...
    onSSR(async () => {
      ...
      if (props.categoryId) {
        searchParameters = {ids: {eq: props.categoryId}};
      } else {
